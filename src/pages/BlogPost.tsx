...
function SectionHeader(props: { kicker?: string; title: string; desc?: string }) {
  return <BlogSectionHeader {...props} />;
}

function FAQItem(props: { q: string; a: string; open: boolean; onToggle: () => void }) {
  return <BlogFAQItem {...props} />;
}
